...
# # Version: 2.1 - Fixed placeholder image detection
...
# __version__ = "2.3"
# # print(f"[boots.py v{__version__}] Loaded")
...
#     # Scene7 placeholders are ~16KB, real images at 1500x1500 are 50KB+
...
#     # Debug: if name is still empty, check what we got
#     if not name:
#         print(f"  [DEBUG] No name found. HTML length: {len(html)}")
#         print(f"  [DEBUG] Title tag: {soup.title}")
#         print(f"  [DEBUG] H1 tags: {len(soup.find_all('h1'))}")
#         # Check if it's an error page
#         if "access denied" in html.lower() or "blocked" in html.lower():
#             print(f"  [DEBUG] Possible block/access denied page")
#         if "captcha" in html.lower():
#             print(f"  [DEBUG] Possible CAPTCHA page")
...
#                 continue
#     if price == "N/A":
#         el = soup.select_one('[data-test="product-price-primary"] h2, .pdp-price h2, .productPrice, .price')
#         if el:
#             gbp = _parse_gbp_from_node_text(el.get_text(" ", strip=True))
#             if gbp:
...
#     # ----- Description -----
#     desc = ""
#     for sel in ["#product_long_description", ".productDescription_content", "#pdpDescription", ".productDescription"]:
...
#     # ----- Images -----
#     # Primary method: Extract from aria-label attributes (authoritative count from website)
...
#     TEST_URL = "https://www.boots.com/laura-ashley-4-5l-stand-mixer-china-rose-10337641"
